...
jugadorVidas            byte 5
jugadorPuntosLo         byte 0
jugadorPuntosHi         byte 0
jugadorNivel            byte 0
jugadorRetardoNivel     byte 5
jugadorMaxPuntosLo      byte 0
jugadorMaxPuntosHi      byte 0
...
aeFinAnimacion
        ...
        lda jugadorPuntosHi
        cmp jugadorMaxPuntosHi
        bcc aeFinAnimacionNoMax ; ¿a < m?

        bne aeFinAnimacionSiMax

        ; jugadorPuntosHi = jugadorMaxPuntosHi
        ; Hay que comparar las partes Lo

        lda jugadorPuntosLo
        cmp jugadorMaxPuntosLo
        bcc aeFinAnimacionNoMax ; ¿a < m?
...
aeFinAnimacionSiMax
        ...
        lda jugadorPuntosHi
        sta jugadorMaxPuntosHi
        lda jugadorPuntosLo
        sta jugadorMaxPuntosLo

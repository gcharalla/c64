...
; Movemos el texto de la derecha al pie. Revisamos los límites verticales para
; jugador, disparos y asteroides. 

; Más adelante, movimiento de los sprites extendido en sentido X.

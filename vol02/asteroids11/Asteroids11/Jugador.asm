...
;        jsr meteRetardo
        ...
        ; Problema: sin retardo la animación va muy rápido y con retardo
        ; se retarda todo el programa, no sólo la animación. Hay que aplicar
        ; una solución similar a la del giro o el disparo: un contador de modo
        ; que se cambie de frame cada X ejecuciones del bucle de juego. Esto,
        ; a su vez, nos lleva a tener una variable jugadorActivo.

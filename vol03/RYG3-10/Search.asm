...
schCatsScoreVsBeta
        ...
        iny
        cmp beta,y
        beq schCatsBetaVsAlpha;schCatsUpdateBeta
...
admAgain
        ...
        lda move_list_score,y
        clc
        adc #HASH_SCORE
        sta move_list_score,y
